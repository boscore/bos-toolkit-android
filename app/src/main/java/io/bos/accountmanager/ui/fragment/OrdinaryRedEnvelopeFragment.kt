...
import kotlinx.android.synthetic.main.fragment_red_envelope_ordinary.*

/**
 * 普通红包
 * Created by Administrator on 2019/1/2/002.
 */
@Route(path = Constants.RoutePath.FRAGMENT.RED_ENVELOPE_ORDINARY_FRAGMENT)
class OrdinaryRedEnvelopeFragment : AbstractBosFragment() {
    ...
    override fun fragmentLayout(): Int {
        return R.layout.fragment_red_envelope_ordinary
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        select_account.setOnClickListener {
            ...
            dialogSelect?.selectAccountCallback = object : SelectAccountDialog.SelectAccountCallback {
                override fun onDetermine(select: AccountTable, positionTag: Int) {
                    this@OrdinaryRedEnvelopeFragment.positionTag = positionTag
        ...
        send.setOnClickListener {
            ...
            when {
                ...
                else -> callBack?.accountRedEnvelope(accountTable!!, amount, 1, count.toInt(), congratulations.text.toString())
            }
        }
